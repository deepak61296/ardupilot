...
> **GSoC 2026: Companion Computer Health Monitor Branch**
> 
> This branch implements the `AP_CompanionHealth` library to monitor the health of companion computers (RPi, Jetson, etc.) and trigger failsafes if they crash or overheat.
>
> **[Watch Demo Video](https://www.youtube.com/watch?v=s6RZwZTwf14)** | **[Companion Script Repository](https://github.com/deepak61296/companion-health-monitor)**
> 
> ---
